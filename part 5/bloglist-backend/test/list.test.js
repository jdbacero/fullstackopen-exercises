...
describe('About likes', () => {
    ...
    test('retrieve most liked blog post', () => {
        expect(listHelper
            .favoriteBlog(blogs))
            .toEqual({ title, author, likes })
    })
})

describe('all about authors', () => {
